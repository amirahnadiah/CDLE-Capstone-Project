...
public class FaceMaskProject {
    private static final Logger log = LoggerFactory.getLogger(FaceMaskProject.class);
    ...
    private static File modelFilename = new File(System.getProperty("user.dir"), "generated-models/FacemaskDetection_tinyyolo.zip");
...
//
    ...
    private static void testWithTestDataset(RecordReaderDataSetIterator test) throws InterruptedException {
        ...
        CanvasFrame canvas = new CanvasFrame("Facemask Detection using test dataset");
    ...
    private static void testWithWebcam() throws InterruptedException {
        ...
        CanvasFrame canvas = new CanvasFrame("Facemask Detection With Webcam");
